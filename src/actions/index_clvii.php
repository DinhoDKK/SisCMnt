  ...
  <div class="header-index bg-success">
    <div class="row justify-content-md-center">
      <div class="logo text col">
        ...
        <div class="container">
      <div class="col-md-6">
        <h5 class="title">Olá <i><?php echo $_SESSION['nomeguerra']; ?></i>, seja bem-vindo(a)!</h5>
      </div>
    </div>
      </div>
    </div>
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../pages/user/cad_clix.php">Cadastro de radios</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Atualizar disponibilidade de radios</a>
              </li>
              <li class="nav-item">
                <a class="nav-link">Informar radio em Mnt</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Informar Descarga de radio</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Verificar disponibilidade de radio </a>
              </li>
              <li class="nav-item">
