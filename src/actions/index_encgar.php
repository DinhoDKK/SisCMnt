...
<html lang="en" dir="ltr">
  ...
  <body>
    <iframe src="header.php" name="logo" width="100%" height="100px"></iframe>
    <div class="info-pessoal"> 
      <p>Posto/Grad.: <?php echo $_SESSION['posto'] ?></p>
    </div>
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../pages/user/cad_clix.php">Cadastro de VTR</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Verificar disponibilidade de VTR</a>
              </li>
              <li class="nav-item">
