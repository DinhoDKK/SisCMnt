    ...
    <div class="container">
      <div class="col-md-11">
        <h2 class="title">Olá <i><?php echo $_SESSION['nomeguerra']; ?></i>, seja bem-vindo(a)!</h2>
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../pages/user/cad_usuario.php">Cadastro de Pessoal</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Consultar disponibilidade por Classe</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Consultar MEM indisponíveis</a>
            </li>
            <li class="nav-item">
              <a class="nav-link">Consultar MEM em manutenção</a>
            </li>
            <li class="nav-item">
              <a class="nav-link">Consultar MEM descarregados</a>
            </li>
            <li class="nav-item">
              <a class="nav-link">Disponibilidade MEM Geral</a>
            </li>
            <li class="nav-item">
              <a class="nav-link">Gráficos da disponibilidade</a>
            </li>
            <li class="nav-item">
