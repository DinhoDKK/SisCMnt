    ...
    <form id="form" name="form" class="form" action="" method="POST" onsubmit="">
        <div class="tab-content">
          <div class="tab-pane active div-tab" id="dados-pessoais" role="tabpanel" aria-labelledby="dados-pessoais-tab">
            ...
            <h3>Cadastro de Material CL V</h3>
           
          <div class="row">

            <div class="col-md-4">
              <label for="numero" class="form-label">Nº do armamento</label>
            ...
            <div class="col-md-6">
                ...
                <select id="tipo" name="tipo" class="form-select">
                  <option selected>Armamento Leve</option>
                </select>
            </div>
