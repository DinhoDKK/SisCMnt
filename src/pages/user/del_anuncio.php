...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <form action="./src/actions/processa_anuncio.php" method="post">
        <div class="col-4">
        ...
        <div class="col-4">
          ...
          <select class="form-select" name="porte" id="porte">
            ...
            <option value="M" <?php echo $result['porte'] == 'M' ? "selected" : "disabled" ?>>Médio</option>
        ...
        <a href="./src/action/index_logado.php" class="btn btn-danger">Cancelar</a>
